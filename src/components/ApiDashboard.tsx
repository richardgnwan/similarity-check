...
import { ApiKey, ApiRequest } from "@prisma/client";
...
const ApiDashboard = async ({}) => {
  ...
  const userRequests: ApiRequest[] = await db.apiRequest.findMany({
    where: {
      apiKeyId: {
  ...
  // We want to display "3 hours ago" instaed of the actual timestamp
